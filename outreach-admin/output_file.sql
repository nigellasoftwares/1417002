...
CREATE TABLE `staff_connection_status` (
  `id` integer NOT NULL PRIMARY KEY AUTOINCREMENT,
  `staff_username` varchar(255) DEFAULT NULL UNIQUE,
  `staff_server_ip` varchar(255) DEFAULT NULL,
  `staff_connection_time` varchar(50) NULL,
...
CREATE TABLE `detailed_dd_doc_status` (
  `id` integer NOT NULL PRIMARY KEY AUTOINCREMENT,
  `doc_status` varchar(255) NOT NULL UNIQUE,
  `category_list` varchar(255) NULL,
  `uuid` varchar(255) NULL
);
CREATE TABLE `employment_detail` (
  `id` integer NOT NULL PRIMARY KEY AUTOINCREMENT,
  `employment_detail` varchar(255) NOT NULL UNIQUE
);


CREATE TABLE `company_list` (
  `id` integer NOT NULL PRIMARY KEY AUTOINCREMENT,
  `worker_registration_prefix` varchar(255) UNIQUE,
  `username` varchar(255) UNIQUE,
  `import_date` varchar(20) DEFAULT NULL,
  `import_time` varchar(20) DEFAULT NULL
);
*/
